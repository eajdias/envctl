...
- Todos os manifestos declarativos (`manifests/`), templates de configuração (`configs/`) e as **74 Skills** de agentes de IA são embutidos diretamente no binário compilado.
