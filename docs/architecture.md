...
│   │   ├── provision_skills.go  # Extração e atualização das 49 Skills
...
- **`ProvisionSkillsUseCase`**: Extrai as 49 Skills do sistema embutido para o diretório local do OpenCode/CommandCode (`~/.config/opencode/skills/` e `~/.commandcode/skills/`).
