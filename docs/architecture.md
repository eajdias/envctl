...
│   │   ├── provision_skills.go  # Extração e atualização das 40 Skills
...
- **`ProvisionSkillsUseCase`**: Extrai as 40 Skills do sistema embutido para o diretório local do OpenCode/CommandCode (`~/.config/opencode/skills/` e `~/.commandcode/skills/`).
