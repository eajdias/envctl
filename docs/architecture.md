...
│   │   ├── provision_skills.go  # Extração e atualização das 38 Skills
...
- **`ProvisionSkillsUseCase`**: Extrai as 38 Skills do sistema embutido para o diretório local do OpenCode/CommandCode (`~/.config/opencode/skills/` e `~/.commandcode/skills/`).
