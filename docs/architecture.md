...
│   │   ├── provision_skills.go  # Extração e atualização das 74 Skills
...
- **`ProvisionSkillsUseCase`**: Extrai as 74 Skills do sistema embutido para o diretório local do OpenCode/CommandCode (`~/.config/opencode/skills/` e `~/.commandcode/skills/`).
