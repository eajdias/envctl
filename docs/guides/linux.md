...
4. Executa `envctl run all` instalando pacotes via `apt-get`, Volta/Node, LSPs e implantando as 40 Skills de IA.
...
# Apenas extração e validação das 40 Skills de Agentes
envctl run skills
