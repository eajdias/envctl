...
- O binário compilado (`envctl` / `envctl.exe`) carrega todos os manifestos declarativos, templates de configuração e as 49 Skills em tempo de compilação.
...
5. **Ecossistema OpenCode & CommandCode com 50 Skills:**
   ...
   - Extração das 49 Skills do OpenCode/CommandCode para `~/.config/opencode/skills`.
