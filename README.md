...
- **Ecossistema OpenCode & CommandCode com 41 Skills**: `opencode.json`, plugins e **41 Skills de Agentes de IA provisionadas** (+ 1 built-in do opencode). Suporte equivalente a **CommandCode** (agente `code-reviewer`, MCPs, configs) — diferenças de plataforma documentadas na [tabela de paridade](docs/skills.md).
...
1. **100% Standalone via `//go:embed`**: Todas as 41 Skills e templates residem dentro do próprio binário executável compilado.
