...
description: >-
  Debloat opt-in do Windows 11 (Tier 3 manual). Use quando o usuário pedir para remover OneDrive, desativar hibernação, trocar power plan, desativar Teredo, escrever .wslconfig com limites, remover Copilot/Recall/Xbox/Teams via winget/Appx, ou aplicar o que o `envctl run debloat` não cobre. Triggers: debloat, desbloat, bloatware, onedrive remover, hibernação, power plan, teredo, wslconfig, recall, copilot remover, Appx.
license: MIT
---

# Windows Debloat (Tier 3 — manual, opt-in)
